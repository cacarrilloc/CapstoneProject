<?php
    ...
    if(isset($_POST["urlInput"])) {
        ...
        $mysqli->query("INSERT INTO images(user_email, name, link)
                  VALUES('$user_email','$name', '$link')");
        
        echo '  </br></br>
                <div class="giveMePadding">
                    </br></br>
                    <p><h3>A new image has been successfully added to '.$user_email.' account!!</h3></p>
                </div>';
    }
?>
