        ...
        echo '<div class="giveMePadding">
                    <div class="giveMePadding">
                        ...
                        <form method="POST" action="update_userInfo.php">
                                <input type="submit" class="btn btn-default" value="UPDATE YOUR INFO" id="updateUserButton"></input>
                        </form>
                    </div></br></br></br></br>
                </div>';
		$my_stmt->fetch();
        ...
        echo '<div class="giveMePadding">
                    <div class="giveMePadding">
                        ...
                        <form method="POST" action="user_signUp.php">
                            <input type="submit" class="btn btn-default" value="Create New Account" id="create"></input>
                        </form>
                    </div><br><br><br><br>
                </div>';
        session_write_close();
