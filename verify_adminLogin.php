                    ...
                    <div class="giveMePadding">
                        ...
                        <div class="row addNew">
                            <form method="POST" action="admin_console.php">
                                <input type="submit" class="btn btn-default" value="CONTINUE" id="continue"></input></form></br>
                            <form method="POST" action="update_adminInfo.php">
                                <input type="submit" class="btn btn-default" value="UPDATE YOUR INFO" id="updateUserButton"></input></form>
                        </div>
                    </div></br></br></br></br>
                </div>';
		$my_stmt->fetch();
                ...
                <div class="giveMePadding">
                    ...
                    <div class="row addNew">
                        <form method="POST" action="admin_login.php">
                            <input type="submit" class="btn btn-default" value="TRY AGAIN" id="tryagain2"></input>
                        </form></br>
                        <form method="POST" action="admin_signUp.php">
                            <input type="submit" class="btn btn-default" value="Create New ADMIN Account" id="create2"></input>
                        </form>
                    </div>
                </div></br></br></br></br>
              </div>';
