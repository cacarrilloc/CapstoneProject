...
<div class="giveMePadding">
    ...
    <div class="giveMePadding">
        <div class="row">
			<h1 class="page-header"><strong>ROVER MAIN NAVIGATION CAM</strong></h1>
        ...
        <div class="row addNew">
            <h3><strong>Follow these steps to DOWNLOAD the Mars Rover picture. Just click on the buttons!</strong></h3>
            <?php
                if(isset($urlPhp)) {
                    echo '  <div id= "second">
                                <p class="api_desc" style="color:white;"><strong>URL '.$urlPhp.'</strong><span id= "showname2"></p>
                            </div></br>
                            <div id = "clear"></div>';
        
                    echo '  <img src='.$urlPhp.' style="color:white;" alt="DO NOT FORGET TO FIRST CLICK ON THE GET BUTTON!!" height=100% width=100%></br></br>';
                } else {
                    echo '
                            <div id= "second">
                                <p class="api_desc" style="color:white;"><strong>URL </strong><span id= "showname2">( Note: THIS CAMERA IS TEMPORARY OUT OF SERVICE IF NO URL SHOWS UP HERE AFTER CLICKING BUTTON 1)<span></p>
                            </div>
                            <div>
                                <button type = "button" class="btn btn-default" id="submit2">1) GET MARS ROVER NAV CAM IMAGE</button></br></br>
                            </div>
                            <div id = "clear"></div>
                            <button class = "btn btn-default" onclick = "VarFunction2()">2) DOWNLOAD IMAGE</button></br></br>';
                }
            ?>
        </div>
    </div>
