...
<div class="giveMePadding">
    ...
    <div class="giveMePadding">
        <div class="row">
            <h1 class="page-header"><strong>ROVER FRONT NAVIGATION CAM</strong></h1>
        ...
        <div class="row addNew">
            ...
            <?php
                if(isset($urlPhp)) {
                    echo '  <div id= "second">
                                <p class="api_desc" style="color:white;"><strong>URL '.$urlPhp.'</strong><span id= "showname3"></p>
                            </div></br>
                            <div id = "clear"></div>';
                    ...
                    echo '
                            <div id= "second">
                                <p class="api_desc" style="color:white;"><strong>URL </strong><span id= "showname3">( Note: THIS CAMERA IS TEMPORARY OUT OF SERVICE IF NO URL SHOWS UP HERE AFTER CLICKING BUTTON 1)<span></p>
                            </div>
                            <div>
                                <button type = "button" class="btn btn-default" id="submit3">1) GET MARS ROVER FRONT CAM IMAGE</button></br></br>
                            </div>
                            <div id = "clear"></div>
                            <button class = "btn btn-default" onclick = "VarFunction3()">2) DOWNLOAD IMAGE</button></br></br>';
                }
            ?>
        </div>
    </div>
