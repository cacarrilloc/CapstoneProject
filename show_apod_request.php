...
<div class="giveMePadding">
    ...
    <div class="giveMePadding">
        <div class="row">
			<h1 class="page-header"><strong>NASA PICTURE OF TODAY</strong></h1>
			<h3>Discover the cosmos! Each day a different image or photograph of our fascinating universe is featured, along with a brief explanation written by a professional astronomer.</h3>
        </div>
        <div class="row addNew">
            <h3><strong>Follow these steps to DOWNLOAD the NASA Picture of the Day. Just click on the buttons!</strong></h3></br>
            <?php
                if(isset($urlPhp)) {
                    echo '  <div id= "second">
                                <p class="api_desc" style="color:white;"><strong>URL '.$urlPhp.'</strong><span id= "showname"></p>
                            </div></br>
                            <div id = "clear"></div>';
                    ...
                    echo '
                            <div id= "second">
                                <p class="api_desc" style="color:white;"><strong>URL </strong><span id= "showname">( Note: THIS CAMERA IS TEMPORARY OUT OF SERVICE IF NO URL SHOWS UP HERE AFTER CLICKING BUTTON 1)<span></p>
                            </div>
                            <div>
                                <button type = "button" class="btn btn-default" id="submit">1) GET NASA PICTURE OF TODAY</button></br></br>
                            </div>
                            <div id = "clear"></div>
                            <button class = "btn btn-default" onclick = "VarFunction()">2) DOWNLOAD IMAGE</button></br></br>';
                }
            ?>
        </div>
    </div>
    ...
    <div class="giveMePadding">
        ...
        <div class="row addNew">
            <form method="POST" action="add_imageNew.php">
                ...
                <input type="submit" class="btn btn-default" style="width:370px" value="POST PICTURE" id="postNewPic"></input>
            </form>
        </div>
    </div></br>
    <div class="giveMePadding">
        <div class="row addNew">
            <form method="POST" action="add_imageExisting.php">
                <input type="hidden" class="form-control" name="userEmail" id="userEmail" value="<?php echo $email ?>">
                <input type="submit" class="btn btn-default" style="width:370px" value="SHARE EXISTING PICTURE" id="shareOldPic"></input>
            </form>
        </div>
    </div></br></br></br></br>
