...
<div class="giveMePadding">
    <div class="giveMePadding">
        ...
        <a href="index.php"><button class = "btn-second" style="color:white;">SIGN OUTt</button></a>
<?php
...
?>
        ...
        <form method="POST" action="admin_console.php">
            <input type="submit" class="btn btn-default" style="width:580px" value="BACK TO ADMIN CONSOLE" id="mainPage"></input>
        </form></br></br></br></br>
</div>
